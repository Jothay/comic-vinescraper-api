...
namespace ComicVine.API.Testing.Mappings.Objects
{
    ...
    public class ObjectIssueMappingExtensionsTests
    {
        ...
        public void Verify_MapToEntityExtension_CallsMapToEntity()
        {
            ...
            mockMapper.Setup(x => x.MapToEntity(It.IsAny<IObjectIssueModel>()));
            ...
            // Assert
            mockMapper.Verify(x => x.MapToEntity(It.IsAny<IObjectIssueModel>()), Times.Once);
        }
        ...
        //    // Arrange
        //    var mockMapper = new Mock<ObjectIssueMapper>();
        //    mockMapper.Setup(x => x.MapToEntity(It.IsAny<IObjectIssueModel>(), ref It.IsAny<IObjectIssue>()));
        //    var mockModel = ObjectIssuesMockingSetup.DoMockingSetupForObjectIssueModel(1);
        ...
        //    // Assert
        //    mockMapper.Verify(x => x.MapToEntity(It.IsAny<IObjectIssueModel>(), ref It.IsAny<IObjectIssue>()), Times.Once);
        //}
        ...
        public void Verify_MapToModelExtension_CallsMapToModel()
        {
            // Arrange
            var mockMapper = new Mock<ObjectIssueMapper>();
            mockMapper.Setup(x => x.MapToModel(It.IsAny<IObjectIssue>()));
            var mockEntity = ObjectIssuesMockingSetup.DoMockingSetupForObjectIssue(1);
            ObjectIssueMapperExtensions.OverrideMapper(mockMapper.Object);
            // Act
            mockEntity.Object.MapToModel();
            // Assert
            mockMapper.Verify(x => x.MapToModel(It.IsAny<IObjectIssue>()), Times.Once);
        }
        ...
        public void Verify_MapToModelLiteExtension_CallsMapToModel()
        {
            // Arrange
            var mockMapper = new Mock<ObjectIssueMapper>();
            mockMapper.Setup(x => x.MapToModelLite(It.IsAny<IObjectIssue>()));
            var mockEntity = ObjectIssuesMockingSetup.DoMockingSetupForObjectIssue(1);
            ObjectIssueMapperExtensions.OverrideMapper(mockMapper.Object);
            // Act
            mockEntity.Object.MapToModelLite();
            // Assert
            mockMapper.Verify(x => x.MapToModelLite(It.IsAny<IObjectIssue>()), Times.Once);
        }
        ...
        public void Verify_MapToModelListingExtension_CallsMapToModel()
        {
            // Arrange
            var mockMapper = new Mock<ObjectIssueMapper>();
            mockMapper.Setup(x => x.MapToModelListing(It.IsAny<IObjectIssue>()));
            var mockEntity = ObjectIssuesMockingSetup.DoMockingSetupForObjectIssue(1);
            ObjectIssueMapperExtensions.OverrideMapper(mockMapper.Object);
            // Act
            mockEntity.Object.MapToModelListing();
            // Assert
            mockMapper.Verify(x => x.MapToModelListing(It.IsAny<IObjectIssue>()), Times.Once);
        }
        ...
        public static Mock<IObjectIssue> DoMockingSetupForObjectIssue(int idReturnValue = 0)
        {
            var mockObjectIssue = new Mock<IObjectIssue>();
            // Mock Functions
            mockObjectIssue.Setup(m => m.Id).Returns(() => idReturnValue);
