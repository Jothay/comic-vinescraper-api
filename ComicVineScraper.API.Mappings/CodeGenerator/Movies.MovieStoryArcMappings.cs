// <auto-generated>
// <copyright file="Movies.IMovieStoryArcMappings.cs" company="jothay.com">
// Copyright (c) 2015 Jothay Tech, Inc. All rights reserved.
// </copyright>
// <summary>Implements the Mapping Layer functions between MovieStoryArc and MovieStoryArcModel.</summary>
...
namespace ComicVineScraper.API.Mappings//.Movies
{
    ...
    public static class MovieStoryArcMapperExtensions
    {
        ...
        public static IMovieStoryArcModel MapToModel(this IMovieStoryArc entity, int currentDepth = 1)
        {
            return Mapper.MapToModel(entity, currentDepth);
        }
        public static IMovieStoryArcModel MapToModelLite(this IMovieStoryArc entity, int currentDepth = 1)
        {
            return Mapper.MapToModelLite(entity, currentDepth);
        }
        public static IMovieStoryArcModel MapToModelListing(this IMovieStoryArc entity, int currentDepth = 1)
        {
    ...
    public class MovieStoryArcMapper : IMovieStoryArcMapper
    {
        ...
        public virtual IMovieStoryArcModel MapToModel(IMovieStoryArc entity, int currentDepth = 1)
        {
            currentDepth++;
        ...
        public virtual IMovieStoryArcModel MapToModelLite(IMovieStoryArc entity, int currentDepth = 1)
        {
            currentDepth++;
        ...
        public virtual IMovieStoryArcModel MapToModelListing(IMovieStoryArc entity, int currentDepth = 1)
        {
            currentDepth++;
