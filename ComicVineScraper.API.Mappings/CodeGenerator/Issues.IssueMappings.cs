// <auto-generated>
// <copyright file="Issues.IIssueMappings.cs" company="jothay.com">
// Copyright (c) 2015 Jothay Tech, Inc. All rights reserved.
// </copyright>
// <summary>Implements the Mapping Layer functions between Issue and IssueModel.</summary>
...
namespace ComicVineScraper.API.Mappings//.Issues
{
    ...
    public static class IssueMapperExtensions
    {
        ...
        public static IIssue MapToEntity(this IIssueModel model, int currentDepth = 1)
        {
            return Mapper.MapToEntity(model, currentDepth);
        }
        public static void MapToEntity(this IIssueModel model, ref IIssue entity, int currentDepth = 1)
        {
            Mapper.MapToEntity(model, ref entity, currentDepth);
        }
        public static IIssueModel MapToModel(this IIssue entity, int currentDepth = 1)
        {
            return Mapper.MapToModel(entity, currentDepth);
        }
        public static IIssueModel MapToModelLite(this IIssue entity, int currentDepth = 1)
        {
            return Mapper.MapToModelLite(entity, currentDepth);
        }
        public static IIssueModel MapToModelListing(this IIssue entity, int currentDepth = 1)
        {
    ...
    {
        public virtual IIssue MapToEntity(IIssueModel model, int currentDepth = 1)
        {
            currentDepth++;
        ...
        public virtual IIssueModel MapToModelLite(IIssue entity, int currentDepth = 1)
        {
            currentDepth++;
        ...
        public virtual IIssueModel MapToModelListing(IIssue entity, int currentDepth = 1)
        {
            currentDepth++;
