// <auto-generated>
// <copyright file="Movies.IMovieMappings.cs" company="jothay.com">
// Copyright (c) 2015 Jothay Tech, Inc. All rights reserved.
// </copyright>
// <summary>Implements the Mapping Layer functions between Movie and MovieModel.</summary>
...
namespace ComicVineScraper.API.Mappings//.Movies
{
    ...
    public static class MovieMapperExtensions
    {
        ...
        public static IMovieModel MapToModel(this IMovie entity, int currentDepth = 1)
        {
            return Mapper.MapToModel(entity, currentDepth);
        }
        public static IMovieModel MapToModelLite(this IMovie entity, int currentDepth = 1)
        {
            return Mapper.MapToModelLite(entity, currentDepth);
        }
        public static IMovieModel MapToModelListing(this IMovie entity, int currentDepth = 1)
        {
    ...
    {
        public virtual IMovie MapToEntity(IMovieModel model, int currentDepth = 1)
        {
            currentDepth++;
        ...
        public virtual IMovieModel MapToModelLite(IMovie entity, int currentDepth = 1)
        {
            currentDepth++;
        ...
        public virtual IMovieModel MapToModelListing(IMovie entity, int currentDepth = 1)
        {
            currentDepth++;
