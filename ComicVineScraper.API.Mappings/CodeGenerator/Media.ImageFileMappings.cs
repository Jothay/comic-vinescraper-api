// <auto-generated>
// <copyright file="Media.IImageFileMappings.cs" company="jothay.com">
// Copyright (c) 2015 Jothay Tech, Inc. All rights reserved.
// </copyright>
// <summary>Implements the Mapping Layer functions between ImageFile and ImageFileModel.</summary>
...
namespace ComicVineScraper.API.Mappings//.Media
{
    ...
    public static class ImageFileMapperExtensions
    {
        ...
        public static IImageFileModel MapToModel(this IImageFile entity, int currentDepth = 1)
        {
            return Mapper.MapToModel(entity, currentDepth);
        }
        public static IImageFileModel MapToModelLite(this IImageFile entity, int currentDepth = 1)
        {
            return Mapper.MapToModelLite(entity, currentDepth);
        }
        public static IImageFileModel MapToModelListing(this IImageFile entity, int currentDepth = 1)
        {
