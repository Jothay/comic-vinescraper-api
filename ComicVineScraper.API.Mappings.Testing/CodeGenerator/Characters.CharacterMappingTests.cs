// <auto-generated>
// <copyright file="Characters.ICharacterMappingTests.cs" company="jothay.com">
// Copyright (c) 2015 Jothay Tech, Inc. All rights reserved.
// </copyright>
// <summary>Implements the CharactersMappingTests class.</summary>
...
namespace ComicVineScraper.API.Testing.Mappings.Characters
{
    ...
    public class CharacterMappingExtensionsTests
    {
        ...
        public void Verify_MapToEntityExtension_CallsMapToEntity()
        {
            ...
            mockMapper.Setup(x => x.MapToEntity(It.IsAny<ICharacterModel>(), It.IsAny<int>()));
            ...
            // Assert
            mockMapper.Verify(x => x.MapToEntity(It.IsAny<ICharacterModel>(), It.IsAny<int>()), Times.Once);
        }
        ...
        //    // Arrange
        //    var mockMapper = new Mock<CharacterMapper>();
        //    mockMapper.Setup(x => x.MapToEntity(It.IsAny<ICharacterModel>(), ref It.IsAny<ICharacter>(), It.IsAny<int>()));
        //    var mockModel = CharactersMockingSetup.DoMockingSetupForCharacterModel(1);
        ...
        //    // Assert
        //    mockMapper.Verify(x => x.MapToEntity(It.IsAny<ICharacterModel>(), ref It.IsAny<ICharacter>(), It.IsAny<int>()), Times.Once);
        //}
        ...
        public void Verify_MapToModelExtension_CallsMapToModel()
        {
            // Arrange
            var mockMapper = new Mock<CharacterMapper>();
            mockMapper.Setup(x => x.MapToModel(It.IsAny<ICharacter>(), It.IsAny<int>()));
            var mockEntity = CharactersMockingSetup.DoMockingSetupForCharacter(1);
            CharacterMapperExtensions.OverrideMapper(mockMapper.Object);
            // Act
            mockEntity.Object.MapToModel();
            // Assert
            mockMapper.Verify(x => x.MapToModel(It.IsAny<ICharacter>(), It.IsAny<int>()), Times.Once);
        }
        ...
        public void Verify_MapToModelLiteExtension_CallsMapToModel()
        {
            // Arrange
            var mockMapper = new Mock<CharacterMapper>();
            mockMapper.Setup(x => x.MapToModelLite(It.IsAny<ICharacter>(), It.IsAny<int>()));
            var mockEntity = CharactersMockingSetup.DoMockingSetupForCharacter(1);
            CharacterMapperExtensions.OverrideMapper(mockMapper.Object);
            // Act
            mockEntity.Object.MapToModelLite();
            // Assert
            mockMapper.Verify(x => x.MapToModelLite(It.IsAny<ICharacter>(), It.IsAny<int>()), Times.Once);
        }
