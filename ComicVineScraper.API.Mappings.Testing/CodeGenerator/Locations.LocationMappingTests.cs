// <auto-generated>
// <copyright file="Locations.ILocationMappingTests.cs" company="jothay.com">
// Copyright (c) 2015 Jothay Tech, Inc. All rights reserved.
// </copyright>
// <summary>Implements the LocationsMappingTests class.</summary>
...
namespace ComicVineScraper.API.Testing.Mappings.Locations
{
    ...
    public class LocationMappingExtensionsTests
    {
        ...
        public void Verify_AreEqualExtension_CallsAreEqual()
        {
            // Arrange
            var mockMapper = new Mock<LocationMapper>();
            mockMapper.Setup(x => x.AreEqual(It.IsAny<ILocationModel>(), It.IsAny<ILocation>()));
            LocationMapperExtensions.OverrideMapper(mockMapper.Object);
            var mockModel = LocationsMockingSetup.DoMockingSetupForLocationModel(1);
            var mockEntity = LocationsMockingSetup.DoMockingSetupForLocation(1);
            // Act
            ...
            // Assert
            mockMapper.Verify(x => x.AreEqual(It.IsAny<ILocationModel>(), It.IsAny<ILocation>()), Times.Once);
        }
    }
