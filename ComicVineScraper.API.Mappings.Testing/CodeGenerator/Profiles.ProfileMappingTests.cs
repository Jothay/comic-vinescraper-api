// <auto-generated>
// <copyright file="Profiles.IProfileMappingTests.cs" company="jothay.com">
// Copyright (c) 2015 Jothay Tech, Inc. All rights reserved.
// </copyright>
// <summary>Implements the ProfilesMappingTests class.</summary>
...
// </auto-generated>
namespace ComicVineScraper.API.Testing.Mappings.Profiles
{
    ...
    public class ProfileMappingExtensionsTests
    {
        ...
        public void Verify_AreEqualExtension_CallsAreEqual()
        {
            // Arrange
            var mockMapper = new Mock<ProfileMapper>();
            mockMapper.Setup(x => x.AreEqual(It.IsAny<IProfileModel>(), It.IsAny<IProfile>()));
            ProfileMapperExtensions.OverrideMapper(mockMapper.Object);
            var mockModel = ProfilesMockingSetup.DoMockingSetupForProfileModel(1);
            var mockEntity = ProfilesMockingSetup.DoMockingSetupForProfile(1);
            // Act
            ...
            // Assert
            mockMapper.Verify(x => x.AreEqual(It.IsAny<IProfileModel>(), It.IsAny<IProfile>()), Times.Once);
        }
    }
