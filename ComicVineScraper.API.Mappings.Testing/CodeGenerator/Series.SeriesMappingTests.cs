// <auto-generated>
// <copyright file="Series.ISeriesMappingTests.cs" company="jothay.com">
// Copyright (c) 2015 Jothay Tech, Inc. All rights reserved.
// </copyright>
// <summary>Implements the SeriesMappingTests class.</summary>
...
namespace ComicVineScraper.API.Testing.Mappings.Series
{
    ...
    public class SeriesMappingExtensionsTests
    {
        ...
        public void Verify_AreEqualExtension_CallsAreEqual()
        {
            // Arrange
            var mockMapper = new Mock<SeriesMapper>();
            mockMapper.Setup(x => x.AreEqual(It.IsAny<ISeriesModel>(), It.IsAny<ISeries>()));
            SeriesMapperExtensions.OverrideMapper(mockMapper.Object);
            var mockModel = SeriesMockingSetup.DoMockingSetupForSeriesModel(1);
            var mockEntity = SeriesMockingSetup.DoMockingSetupForSeries(1);
            // Act
            ...
            // Assert
            mockMapper.Verify(x => x.AreEqual(It.IsAny<ISeriesModel>(), It.IsAny<ISeries>()), Times.Once);
        }
    }
