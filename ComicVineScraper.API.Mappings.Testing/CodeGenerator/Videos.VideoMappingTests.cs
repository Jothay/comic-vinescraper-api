// <auto-generated>
// <copyright file="Videos.IVideoMappingTests.cs" company="jothay.com">
// Copyright (c) 2015 Jothay Tech, Inc. All rights reserved.
// </copyright>
// <summary>Implements the VideosMappingTests class.</summary>
...
namespace ComicVineScraper.API.Testing.Mappings.Videos
{
    ...
    public class VideoMappingExtensionsTests
    {
        ...
        public void Verify_AreEqualExtension_CallsAreEqual()
        {
            // Arrange
            var mockMapper = new Mock<VideoMapper>();
            mockMapper.Setup(x => x.AreEqual(It.IsAny<IVideoModel>(), It.IsAny<IVideo>()));
            VideoMapperExtensions.OverrideMapper(mockMapper.Object);
            var mockModel = VideosMockingSetup.DoMockingSetupForVideoModel(1);
            var mockEntity = VideosMockingSetup.DoMockingSetupForVideo(1);
            // Act
            ...
            // Assert
            mockMapper.Verify(x => x.AreEqual(It.IsAny<IVideoModel>(), It.IsAny<IVideo>()), Times.Once);
        }
    }
