// <auto-generated>
// <copyright file="Videos.IVideoTypeMappingTests.cs" company="jothay.com">
// Copyright (c) 2015 Jothay Tech, Inc. All rights reserved.
// </copyright>
// <summary>Implements the VideoTypesMappingTests class.</summary>
...
// </auto-generated>
namespace ComicVineScraper.API.Testing.Mappings.Videos
{
    ...
    public class VideoTypeMappingExtensionsTests
    {
        ...
        public void Verify_MapToEntityExtension_CallsMapToEntity()
        {
            ...
            mockMapper.Setup(x => x.MapToEntity(It.IsAny<IVideoTypeModel>(), It.IsAny<int>()));
            ...
            // Assert
            mockMapper.Verify(x => x.MapToEntity(It.IsAny<IVideoTypeModel>(), It.IsAny<int>()), Times.Once);
        }
        ...
        //    // Arrange
        //    var mockMapper = new Mock<VideoTypeMapper>();
        //    mockMapper.Setup(x => x.MapToEntity(It.IsAny<IVideoTypeModel>(), ref It.IsAny<IVideoType>(), It.IsAny<int>()));
        //    var mockModel = VideoTypesMockingSetup.DoMockingSetupForVideoTypeModel(1);
        ...
        //    // Assert
        //    mockMapper.Verify(x => x.MapToEntity(It.IsAny<IVideoTypeModel>(), ref It.IsAny<IVideoType>(), It.IsAny<int>()), Times.Once);
        //}
        ...
        public void Verify_MapToModelExtension_CallsMapToModel()
        {
            // Arrange
            var mockMapper = new Mock<VideoTypeMapper>();
            mockMapper.Setup(x => x.MapToModel(It.IsAny<IVideoType>(), It.IsAny<int>()));
            var mockEntity = VideoTypesMockingSetup.DoMockingSetupForVideoType(1);
            VideoTypeMapperExtensions.OverrideMapper(mockMapper.Object);
            // Act
            mockEntity.Object.MapToModel();
            // Assert
            mockMapper.Verify(x => x.MapToModel(It.IsAny<IVideoType>(), It.IsAny<int>()), Times.Once);
        }
        ...
        public void Verify_MapToModelLiteExtension_CallsMapToModel()
        {
            // Arrange
            var mockMapper = new Mock<VideoTypeMapper>();
            mockMapper.Setup(x => x.MapToModelLite(It.IsAny<IVideoType>(), It.IsAny<int>()));
            var mockEntity = VideoTypesMockingSetup.DoMockingSetupForVideoType(1);
            VideoTypeMapperExtensions.OverrideMapper(mockMapper.Object);
            // Act
            mockEntity.Object.MapToModelLite();
            // Assert
            mockMapper.Verify(x => x.MapToModelLite(It.IsAny<IVideoType>(), It.IsAny<int>()), Times.Once);
        }
        ...
        public void Verify_MapToModelListingExtension_CallsMapToModel()
        {
            // Arrange
            var mockMapper = new Mock<VideoTypeMapper>();
            mockMapper.Setup(x => x.MapToModelListing(It.IsAny<IVideoType>(), It.IsAny<int>()));
            var mockEntity = VideoTypesMockingSetup.DoMockingSetupForVideoType(1);
            VideoTypeMapperExtensions.OverrideMapper(mockMapper.Object);
            // Act
            mockEntity.Object.MapToModelListing();
            // Assert
            mockMapper.Verify(x => x.MapToModelListing(It.IsAny<IVideoType>(), It.IsAny<int>()), Times.Once);
        }
