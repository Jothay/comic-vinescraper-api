// <auto-generated>
// <copyright file="Characters.ICharacterPowerMappingTests.cs" company="jothay.com">
// Copyright (c) 2015 Jothay Tech, Inc. All rights reserved.
// </copyright>
// <summary>Implements the CharacterPowersMappingTests class.</summary>
...
namespace ComicVineScraper.API.Testing.Mappings.Characters
{
    ...
    public class CharacterPowerMappingExtensionsTests
    {
        ...
        public void Verify_AreEqualExtension_CallsAreEqual()
        {
            // Arrange
            var mockMapper = new Mock<CharacterPowerMapper>();
            mockMapper.Setup(x => x.AreEqual(It.IsAny<ICharacterPowerModel>(), It.IsAny<ICharacterPower>()));
            CharacterPowerMapperExtensions.OverrideMapper(mockMapper.Object);
            var mockModel = CharacterPowersMockingSetup.DoMockingSetupForCharacterPowerModel(1);
            var mockEntity = CharacterPowersMockingSetup.DoMockingSetupForCharacterPower(1);
            // Act
            ...
            // Assert
            mockMapper.Verify(x => x.AreEqual(It.IsAny<ICharacterPowerModel>(), It.IsAny<ICharacterPower>()), Times.Once);
        }
    }
