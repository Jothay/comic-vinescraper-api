// <auto-generated>
// <copyright file="Powers.IPowerAliasServices.cs" company="clarityventures.com">
...
namespace ComicVine.API.Testing.Services//.Powers
{
    ...
    public partial class AllServicesTests
    {
        ...
        public void Verify_GetPowerAliases_Should_ReturnAListOfPowerAliasModels()
        {
            ...
            var response = service.Any(new GetPowerAliases { Id = 1, CustomKey = "KING-STEPHEN", ApiDetailUrl = "/TEST/KING-STEPHEN", Name = "Stephen King", Description = null, ModifiedSince = DateTime.Now, Paging = null });
        ...
        {
            var service = AppHost.Container.Resolve<IPowerAliasesServices>();
            var response = service.Any(new GetPowerAliasesAsListing { Id = 1, CustomKey = "KING-STEPHEN", ApiDetailUrl = "/TEST/KING-STEPHEN", Name = "Stephen King", Description = "famous", ModifiedSince = DateTime.Now, Paging = null });
            Assert.IsType<List<IPowerAliasModel>>(response);
        }
        [Fact][Trait("Category", "PowerAliases")]
        ...
        {
            var service = AppHost.Container.Resolve<IPowerAliasesServices>();
            var response = service.Any(new CreatePowerAlias { Name = "Stephen King", CustomKey = "KING-STEPHEN", Active = true, CreatedDate = DateTime.Now, UpdatedDate = DateTime.Now });
            Assert.Equal(nameof(IPowerAliasModel), response.GetType().Name.Replace("Proxy", ""));
        }
        [Fact][Trait("Category", "PowerAliases")]
