// <auto-generated>
// <copyright file="Movies.IMovieServices.cs" company="clarityventures.com">
...
namespace ComicVine.API.Testing.Services//.Movies
{
    ...
    public partial class AllServicesTests
    {
        ...
        public void Verify_GetMovies_Should_ReturnAListOfMovieModels()
        {
            ...
            var response = service.Any(new GetMovies { Id = 1, CustomKey = "KING-STEPHEN", ApiDetailUrl = "/TEST/KING-STEPHEN", Name = "Stephen King", Description = null, ModifiedSince = DateTime.Now, Paging = null });
        ...
        {
            var service = AppHost.Container.Resolve<IMoviesServices>();
            var response = service.Any(new GetMoviesAsListing { Id = 1, CustomKey = "KING-STEPHEN", ApiDetailUrl = "/TEST/KING-STEPHEN", Name = "Stephen King", Description = "famous", ModifiedSince = DateTime.Now, Paging = null });
            Assert.IsType<List<IMovieModel>>(response);
        }
        [Fact][Trait("Category", "Movies")]
        ...
        {
            var service = AppHost.Container.Resolve<IMoviesServices>();
            var response = service.Any(new CreateMovie { Name = "Stephen King", CustomKey = "KING-STEPHEN", Active = true, CreatedDate = DateTime.Now, UpdatedDate = DateTime.Now });
            Assert.Equal(nameof(IMovieModel), response.GetType().Name.Replace("Proxy", ""));
        }
        [Fact][Trait("Category", "Movies")]
