// <auto-generated>
// <copyright file="Characters.ICharacterServices.cs" company="clarityventures.com">
...
namespace ComicVine.API.Testing.Services//.Characters
{
    ...
    public partial class AllServicesTests
    {
        ...
        public void Verify_GetCharacters_Should_ReturnAListOfCharacterModels()
        {
            ...
            var response = service.Any(new GetCharacters { Id = 1, CustomKey = "KING-STEPHEN", ApiDetailUrl = "/TEST/KING-STEPHEN", Name = "Stephen King", Description = null, ModifiedSince = DateTime.Now, Paging = null });
        ...
        {
            var service = AppHost.Container.Resolve<ICharactersServices>();
            var response = service.Any(new GetCharactersAsListing { Id = 1, CustomKey = "KING-STEPHEN", ApiDetailUrl = "/TEST/KING-STEPHEN", Name = "Stephen King", Description = "famous", ModifiedSince = DateTime.Now, Paging = null });
            Assert.IsType<List<ICharacterModel>>(response);
        }
        [Fact][Trait("Category", "Characters")]
        ...
        {
            var service = AppHost.Container.Resolve<ICharactersServices>();
            var response = service.Any(new CreateCharacter { Name = "Stephen King", CustomKey = "KING-STEPHEN", Active = true, CreatedDate = DateTime.Now, UpdatedDate = DateTime.Now });
            Assert.Equal(nameof(ICharacterModel), response.GetType().Name.Replace("Proxy", ""));
        }
        [Fact][Trait("Category", "Characters")]
