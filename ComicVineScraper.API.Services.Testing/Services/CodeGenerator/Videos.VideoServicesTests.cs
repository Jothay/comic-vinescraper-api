// <auto-generated>
// <copyright file="Videos.IVideoServices.cs" company="clarityventures.com">
...
namespace ComicVine.API.Testing.Services//.Videos
{
    ...
    public partial class AllServicesTests
    {
        ...
        public void Verify_GetVideos_Should_ReturnAListOfVideoModels()
        {
            ...
            var response = service.Any(new GetVideos { Id = 1, CustomKey = "KING-STEPHEN", ApiDetailUrl = "/TEST/KING-STEPHEN", Name = "Stephen King", Description = null, ModifiedSince = DateTime.Now, Paging = null });
        ...
        {
            var service = AppHost.Container.Resolve<IVideosServices>();
            var response = service.Any(new GetVideosAsListing { Id = 1, CustomKey = "KING-STEPHEN", ApiDetailUrl = "/TEST/KING-STEPHEN", Name = "Stephen King", Description = "famous", ModifiedSince = DateTime.Now, Paging = null });
            Assert.IsType<List<IVideoModel>>(response);
        }
        [Fact][Trait("Category", "Videos")]
        ...
        {
            var service = AppHost.Container.Resolve<IVideosServices>();
            var response = service.Any(new CreateVideo { Name = "Stephen King", CustomKey = "KING-STEPHEN", Active = true, CreatedDate = DateTime.Now, UpdatedDate = DateTime.Now });
            Assert.Equal(nameof(IVideoModel), response.GetType().Name.Replace("Proxy", ""));
        }
        [Fact][Trait("Category", "Videos")]
