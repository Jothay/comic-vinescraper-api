// <auto-generated>
// <copyright file="Concepts.IConceptServices.cs" company="clarityventures.com">
...
namespace ComicVine.API.Testing.Services//.Concepts
{
    ...
    public partial class AllServicesTests
    {
        ...
        public void Verify_GetConcepts_Should_ReturnAListOfConceptModels()
        {
            ...
            var response = service.Any(new GetConcepts { Id = 1, CustomKey = "KING-STEPHEN", ApiDetailUrl = "/TEST/KING-STEPHEN", Name = "Stephen King", Description = null, ModifiedSince = DateTime.Now, Paging = null });
        ...
        {
            var service = AppHost.Container.Resolve<IConceptsServices>();
            var response = service.Any(new GetConceptsAsListing { Id = 1, CustomKey = "KING-STEPHEN", ApiDetailUrl = "/TEST/KING-STEPHEN", Name = "Stephen King", Description = "famous", ModifiedSince = DateTime.Now, Paging = null });
            Assert.IsType<List<IConceptModel>>(response);
        }
        [Fact][Trait("Category", "Concepts")]
        ...
        {
            var service = AppHost.Container.Resolve<IConceptsServices>();
            var response = service.Any(new CreateConcept { Name = "Stephen King", CustomKey = "KING-STEPHEN", Active = true, CreatedDate = DateTime.Now, UpdatedDate = DateTime.Now });
            Assert.Equal(nameof(IConceptModel), response.GetType().Name.Replace("Proxy", ""));
        }
        [Fact][Trait("Category", "Concepts")]
