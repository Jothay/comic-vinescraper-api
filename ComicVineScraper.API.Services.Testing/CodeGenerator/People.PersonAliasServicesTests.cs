// <auto-generated>
// <copyright file="People.IPersonAliasServicesTests.cs" company="jothay.com">
// Copyright (c) 2015 Jothay Tech, Inc. All rights reserved.
// </copyright>
// <summary>Declares the PersonAliases ServiceStack Services Tests.</summary>
...
namespace ComicVineScraper.API.Testing.Services//.People
{
    ...
    public partial class AllServicesTests
    {
        ...
        public void Verify_GetPersonAliases_Should_ReturnAListOfPersonAliasModels()
        {
            ...
            var response = service.Any(new GetPersonAliases { Id = 1, CustomKey = "KING-STEPHEN", ApiDetailUrl = "/TEST/KING-STEPHEN",  ModifiedSince = DateTime.Now, Paging = null });
        ...
        {
            var service = AppHost.Container.Resolve<IPersonAliasesServices>();
            var response = service.Any(new GetPersonAliasesAsListing { Id = 1, CustomKey = "KING-STEPHEN", ApiDetailUrl = "/TEST/KING-STEPHEN",  ModifiedSince = DateTime.Now, Paging = null });
            Assert.IsType<List<IPersonAliasModel>>(response);
        }
        [Fact][Trait("Category", "PersonAliases")]
        ...
        {
            var service = AppHost.Container.Resolve<IPersonAliasesServices>();
            var response = service.Any(new CreatePersonAlias { CustomKey = "KING-STEPHEN", Active = true, CreatedDate = DateTime.Now, UpdatedDate = DateTime.Now });
            Assert.Equal(nameof(IPersonAliasModel), response.GetType().Name.Replace("Proxy", ""));
        }
        [Fact][Trait("Category", "PersonAliases")]
