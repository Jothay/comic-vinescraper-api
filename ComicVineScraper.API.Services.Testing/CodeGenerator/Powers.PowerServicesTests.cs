// <auto-generated>
// <copyright file="Powers.IPowerServicesTests.cs" company="jothay.com">
// Copyright (c) 2015 Jothay Tech, Inc. All rights reserved.
// </copyright>
// <summary>Declares the Powers ServiceStack Services Tests.</summary>
...
namespace ComicVineScraper.API.Testing.Services//.Powers
{
    ...
    public partial class AllServicesTests
    {
        ...
        public void Verify_GetPowers_Should_ReturnAListOfPowerModels()
        {
            ...
            var response = service.Any(new GetPowers { Id = 1, CustomKey = "KING-STEPHEN", ApiDetailUrl = "/TEST/KING-STEPHEN",  ModifiedSince = DateTime.Now, Paging = null });
        ...
        {
            var service = AppHost.Container.Resolve<IPowersServices>();
            var response = service.Any(new GetPowersAsListing { Id = 1, CustomKey = "KING-STEPHEN", ApiDetailUrl = "/TEST/KING-STEPHEN",  ModifiedSince = DateTime.Now, Paging = null });
            Assert.IsType<List<IPowerModel>>(response);
        }
        [Fact][Trait("Category", "Powers")]
        ...
        {
            var service = AppHost.Container.Resolve<IPowersServices>();
            var response = service.Any(new CreatePower { CustomKey = "KING-STEPHEN", Active = true, CreatedDate = DateTime.Now, UpdatedDate = DateTime.Now });
            Assert.Equal(nameof(IPowerModel), response.GetType().Name.Replace("Proxy", ""));
        }
        [Fact][Trait("Category", "Powers")]
