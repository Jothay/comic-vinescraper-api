// <auto-generated>
// <copyright file="Videos.IVideoTypeServicesTests.cs" company="jothay.com">
// Copyright (c) 2015 Jothay Tech, Inc. All rights reserved.
// </copyright>
// <summary>Declares the VideoTypes ServiceStack Services Tests.</summary>
...
namespace ComicVineScraper.API.Testing.Services//.Videos
{
    ...
    public partial class AllServicesTests
    {
        ...
        public void Verify_GetVideoTypes_Should_ReturnAListOfVideoTypeModels()
        {
            ...
            var response = service.Any(new GetVideoTypes { Id = 1, CustomKey = "KING-STEPHEN", ApiDetailUrl = "/TEST/KING-STEPHEN",  ModifiedSince = DateTime.Now, Paging = null });
        ...
        {
            var service = AppHost.Container.Resolve<IVideoTypesServices>();
            var response = service.Any(new GetVideoTypesAsListing { Id = 1, CustomKey = "KING-STEPHEN", ApiDetailUrl = "/TEST/KING-STEPHEN",  ModifiedSince = DateTime.Now, Paging = null });
            Assert.IsType<List<IVideoTypeModel>>(response);
        }
        [Fact][Trait("Category", "VideoTypes")]
        ...
        {
            var service = AppHost.Container.Resolve<IVideoTypesServices>();
            var response = service.Any(new CreateVideoType { CustomKey = "KING-STEPHEN", Active = true, CreatedDate = DateTime.Now, UpdatedDate = DateTime.Now });
            Assert.Equal(nameof(IVideoTypeModel), response.GetType().Name.Replace("Proxy", ""));
        }
        [Fact][Trait("Category", "VideoTypes")]
