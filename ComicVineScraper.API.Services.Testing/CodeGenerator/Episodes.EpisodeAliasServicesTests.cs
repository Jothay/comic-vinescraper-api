// <auto-generated>
// <copyright file="Episodes.IEpisodeAliasServicesTests.cs" company="jothay.com">
// Copyright (c) 2015 Jothay Tech, Inc. All rights reserved.
// </copyright>
// <summary>Declares the EpisodeAliases ServiceStack Services Tests.</summary>
...
namespace ComicVineScraper.API.Testing.Services//.Episodes
{
    ...
    public partial class AllServicesTests
    {
        ...
        public void Verify_GetEpisodeAliases_Should_ReturnAListOfEpisodeAliasModels()
        {
            ...
            var response = service.Any(new GetEpisodeAliases { Id = 1, CustomKey = "KING-STEPHEN", ApiDetailUrl = "/TEST/KING-STEPHEN",  ModifiedSince = DateTime.Now, Paging = null });
        ...
        {
            var service = AppHost.Container.Resolve<IEpisodeAliasesServices>();
            var response = service.Any(new GetEpisodeAliasesAsListing { Id = 1, CustomKey = "KING-STEPHEN", ApiDetailUrl = "/TEST/KING-STEPHEN",  ModifiedSince = DateTime.Now, Paging = null });
            Assert.IsType<List<IEpisodeAliasModel>>(response);
        }
        [Fact][Trait("Category", "EpisodeAliases")]
        ...
        {
            var service = AppHost.Container.Resolve<IEpisodeAliasesServices>();
            var response = service.Any(new CreateEpisodeAlias { CustomKey = "KING-STEPHEN", Active = true, CreatedDate = DateTime.Now, UpdatedDate = DateTime.Now });
            Assert.Equal(nameof(IEpisodeAliasModel), response.GetType().Name.Replace("Proxy", ""));
        }
        [Fact][Trait("Category", "EpisodeAliases")]
