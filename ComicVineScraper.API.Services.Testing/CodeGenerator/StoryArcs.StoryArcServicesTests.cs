// <auto-generated>
// <copyright file="StoryArcs.IStoryArcServicesTests.cs" company="jothay.com">
// Copyright (c) 2015 Jothay Tech, Inc. All rights reserved.
// </copyright>
// <summary>Declares the StoryArcs ServiceStack Services Tests.</summary>
...
namespace ComicVineScraper.API.Testing.Services//.StoryArcs
{
    ...
    public partial class AllServicesTests
    {
        ...
        public void Verify_GetStoryArcs_Should_ReturnAListOfStoryArcModels()
        {
            ...
            var response = service.Any(new GetStoryArcs { Id = 1, CustomKey = "KING-STEPHEN", ApiDetailUrl = "/TEST/KING-STEPHEN",  ModifiedSince = DateTime.Now, Paging = null });
        ...
        {
            var service = AppHost.Container.Resolve<IStoryArcsServices>();
            var response = service.Any(new GetStoryArcsAsListing { Id = 1, CustomKey = "KING-STEPHEN", ApiDetailUrl = "/TEST/KING-STEPHEN",  ModifiedSince = DateTime.Now, Paging = null });
            Assert.IsType<List<IStoryArcModel>>(response);
        }
        [Fact][Trait("Category", "StoryArcs")]
        ...
        {
            var service = AppHost.Container.Resolve<IStoryArcsServices>();
            var response = service.Any(new CreateStoryArc { CustomKey = "KING-STEPHEN", Active = true, CreatedDate = DateTime.Now, UpdatedDate = DateTime.Now });
            Assert.Equal(nameof(IStoryArcModel), response.GetType().Name.Replace("Proxy", ""));
        }
        [Fact][Trait("Category", "StoryArcs")]
