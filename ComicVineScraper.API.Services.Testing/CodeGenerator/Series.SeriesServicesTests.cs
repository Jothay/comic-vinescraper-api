// <auto-generated>
// <copyright file="Series.ISeriesServicesTests.cs" company="jothay.com">
// Copyright (c) 2015 Jothay Tech, Inc. All rights reserved.
// </copyright>
// <summary>Declares the Series ServiceStack Services Tests.</summary>
...
namespace ComicVineScraper.API.Testing.Services//.Series
{
    ...
    public partial class AllServicesTests
    {
        ...
        public void Verify_GetSeries_Should_ReturnAListOfSeriesModels()
        {
            ...
            var response = service.Any(new GetAnySeries { Id = 1, CustomKey = "KING-STEPHEN", ApiDetailUrl = "/TEST/KING-STEPHEN",  ModifiedSince = DateTime.Now, Paging = null });
        ...
        {
            var service = AppHost.Container.Resolve<ISeriesServices>();
            var response = service.Any(new GetAnySeriesAsListing { Id = 1, CustomKey = "KING-STEPHEN", ApiDetailUrl = "/TEST/KING-STEPHEN",  ModifiedSince = DateTime.Now, Paging = null });
            Assert.IsType<List<ISeriesModel>>(response);
        }
        [Fact][Trait("Category", "Series")]
        ...
        {
            var service = AppHost.Container.Resolve<ISeriesServices>();
            var response = service.Any(new CreateSeries { CustomKey = "KING-STEPHEN", Active = true, CreatedDate = DateTime.Now, UpdatedDate = DateTime.Now });
            Assert.Equal(nameof(ISeriesModel), response.GetType().Name.Replace("Proxy", ""));
        }
        [Fact][Trait("Category", "Series")]
