// <auto-generated>
// <copyright file="Concepts.IConceptAliasServicesTests.cs" company="jothay.com">
// Copyright (c) 2015 Jothay Tech, Inc. All rights reserved.
// </copyright>
// <summary>Declares the ConceptAliases ServiceStack Services Tests.</summary>
...
namespace ComicVineScraper.API.Testing.Services//.Concepts
{
    ...
    public partial class AllServicesTests
    {
        ...
        public void Verify_GetConceptAliases_Should_ReturnAListOfConceptAliasModels()
        {
            ...
            var response = service.Any(new GetConceptAliases { Id = 1, CustomKey = "KING-STEPHEN", ApiDetailUrl = "/TEST/KING-STEPHEN",  ModifiedSince = DateTime.Now, Paging = null });
        ...
        {
            var service = AppHost.Container.Resolve<IConceptAliasesServices>();
            var response = service.Any(new GetConceptAliasesAsListing { Id = 1, CustomKey = "KING-STEPHEN", ApiDetailUrl = "/TEST/KING-STEPHEN",  ModifiedSince = DateTime.Now, Paging = null });
            Assert.IsType<List<IConceptAliasModel>>(response);
        }
        [Fact][Trait("Category", "ConceptAliases")]
        ...
        {
            var service = AppHost.Container.Resolve<IConceptAliasesServices>();
            var response = service.Any(new CreateConceptAlias { CustomKey = "KING-STEPHEN", Active = true, CreatedDate = DateTime.Now, UpdatedDate = DateTime.Now });
            Assert.Equal(nameof(IConceptAliasModel), response.GetType().Name.Replace("Proxy", ""));
        }
        [Fact][Trait("Category", "ConceptAliases")]
