// <auto-generated>
// <copyright file="People.IPersonServicesTests.cs" company="jothay.com">
// Copyright (c) 2015 Jothay Tech, Inc. All rights reserved.
// </copyright>
// <summary>Declares the People ServiceStack Services Tests.</summary>
...
namespace ComicVineScraper.API.Testing.Services//.People
{
    ...
    public partial class AllServicesTests
    {
        ...
        public void Verify_GetPeople_Should_ReturnAListOfPersonModels()
        {
            ...
            var response = service.Any(new GetPeople { Id = 1, CustomKey = "KING-STEPHEN", ApiDetailUrl = "/TEST/KING-STEPHEN",  ModifiedSince = DateTime.Now, Paging = null });
        ...
        {
            var service = AppHost.Container.Resolve<IPeopleServices>();
            var response = service.Any(new GetPeopleAsListing { Id = 1, CustomKey = "KING-STEPHEN", ApiDetailUrl = "/TEST/KING-STEPHEN",  ModifiedSince = DateTime.Now, Paging = null });
            Assert.IsType<List<IPersonModel>>(response);
        }
        [Fact][Trait("Category", "People")]
        ...
        {
            var service = AppHost.Container.Resolve<IPeopleServices>();
            var response = service.Any(new CreatePerson { CustomKey = "KING-STEPHEN", Active = true, CreatedDate = DateTime.Now, UpdatedDate = DateTime.Now });
            Assert.Equal(nameof(IPersonModel), response.GetType().Name.Replace("Proxy", ""));
        }
        [Fact][Trait("Category", "People")]
