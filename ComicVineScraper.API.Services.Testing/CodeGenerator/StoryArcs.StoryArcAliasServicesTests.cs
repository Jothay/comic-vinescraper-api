// <auto-generated>
// <copyright file="StoryArcs.IStoryArcAliasServicesTests.cs" company="jothay.com">
// Copyright (c) 2015 Jothay Tech, Inc. All rights reserved.
// </copyright>
// <summary>Declares the StoryArcAliases ServiceStack Services Tests.</summary>
...
namespace ComicVineScraper.API.Testing.Services//.StoryArcs
{
    ...
    public partial class AllServicesTests
    {
        ...
        public void Verify_GetStoryArcAliases_Should_ReturnAListOfStoryArcAliasModels()
        {
            ...
            var response = service.Any(new GetStoryArcAliases { Id = 1, CustomKey = "KING-STEPHEN", ApiDetailUrl = "/TEST/KING-STEPHEN",  ModifiedSince = DateTime.Now, Paging = null });
        ...
        {
            var service = AppHost.Container.Resolve<IStoryArcAliasesServices>();
            var response = service.Any(new GetStoryArcAliasesAsListing { Id = 1, CustomKey = "KING-STEPHEN", ApiDetailUrl = "/TEST/KING-STEPHEN",  ModifiedSince = DateTime.Now, Paging = null });
            Assert.IsType<List<IStoryArcAliasModel>>(response);
        }
        [Fact][Trait("Category", "StoryArcAliases")]
        ...
        {
            var service = AppHost.Container.Resolve<IStoryArcAliasesServices>();
            var response = service.Any(new CreateStoryArcAlias { CustomKey = "KING-STEPHEN", Active = true, CreatedDate = DateTime.Now, UpdatedDate = DateTime.Now });
            Assert.Equal(nameof(IStoryArcAliasModel), response.GetType().Name.Replace("Proxy", ""));
        }
        [Fact][Trait("Category", "StoryArcAliases")]
