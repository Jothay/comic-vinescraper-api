// <auto-generated>
// <copyright file="Objects.IObjectServicesTests.cs" company="jothay.com">
// Copyright (c) 2015 Jothay Tech, Inc. All rights reserved.
// </copyright>
// <summary>Declares the Objects ServiceStack Services Tests.</summary>
...
namespace ComicVineScraper.API.Testing.Services//.Objects
{
    ...
    public partial class AllServicesTests
    {
        ...
        public void Verify_GetObjects_Should_ReturnAListOfObjectModels()
        {
            ...
            var response = service.Any(new GetObjects { Id = 1, CustomKey = "KING-STEPHEN", ApiDetailUrl = "/TEST/KING-STEPHEN",  ModifiedSince = DateTime.Now, Paging = null });
        ...
        {
            var service = AppHost.Container.Resolve<IObjectsServices>();
            var response = service.Any(new GetObjectsAsListing { Id = 1, CustomKey = "KING-STEPHEN", ApiDetailUrl = "/TEST/KING-STEPHEN",  ModifiedSince = DateTime.Now, Paging = null });
            Assert.IsType<List<IObjectModel>>(response);
        }
        [Fact][Trait("Category", "Objects")]
        ...
        {
            var service = AppHost.Container.Resolve<IObjectsServices>();
            var response = service.Any(new CreateObject { CustomKey = "KING-STEPHEN", Active = true, CreatedDate = DateTime.Now, UpdatedDate = DateTime.Now });
            Assert.Equal(nameof(IObjectModel), response.GetType().Name.Replace("Proxy", ""));
        }
        [Fact][Trait("Category", "Objects")]
