// <auto-generated>
// <copyright file="Media.IImageFileServicesTests.cs" company="jothay.com">
// Copyright (c) 2015 Jothay Tech, Inc. All rights reserved.
// </copyright>
// <summary>Declares the ImageFiles ServiceStack Services Tests.</summary>
...
// </auto-generated>
namespace ComicVineScraper.API.Testing.Services//.Media
{
    using System;
    ...
    public partial class AllServicesTests
    {
        ...
        public void Verify_GetImageFiles_Should_ReturnAListOfImageFileModels()
        {
            ...
            var response = service.Any(new GetImageFiles { Id = 1, CustomKey = "KING-STEPHEN", ApiDetailUrl = "/TEST/KING-STEPHEN",  ModifiedSince = DateTime.Now, Paging = null });
        ...
        {
            var service = AppHost.Container.Resolve<IImageFilesServices>();
            var response = service.Any(new GetImageFilesAsListing { Id = 1, CustomKey = "KING-STEPHEN", ApiDetailUrl = "/TEST/KING-STEPHEN",  ModifiedSince = DateTime.Now, Paging = null });
            Assert.IsType<List<IImageFileModel>>(response);
        }
        [Fact][Trait("Category", "ImageFiles")]
        ...
        {
            var service = AppHost.Container.Resolve<IImageFilesServices>();
            var response = service.Any(new CreateImageFile { CustomKey = "KING-STEPHEN", Active = true, CreatedDate = DateTime.Now, UpdatedDate = DateTime.Now });
            Assert.Equal(nameof(IImageFileModel), response.GetType().Name.Replace("Proxy", ""));
        }
        [Fact][Trait("Category", "ImageFiles")]
