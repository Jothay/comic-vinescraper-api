// <auto-generated>
// <copyright file="Objects.IObjectAliasServices.cs" company="clarityventures.com">
...
namespace ComicVine.API.Testing.Services//.Objects
{
    ...
    public partial class AllServicesTests
    {
        ...
        public void Verify_GetObjectAliases_Should_ReturnAListOfObjectAliasModels()
        {
            ...
            var response = service.Any(new GetObjectAliases { Id = 1, CustomKey = "KING-STEPHEN", ApiDetailUrl = "/TEST/KING-STEPHEN", Name = "Stephen King", Description = null, ModifiedSince = DateTime.Now, Paging = null });
        ...
        {
            var service = AppHost.Container.Resolve<IObjectAliasesServices>();
            var response = service.Any(new GetObjectAliasesAsListing { Id = 1, CustomKey = "KING-STEPHEN", ApiDetailUrl = "/TEST/KING-STEPHEN", Name = "Stephen King", Description = "famous", ModifiedSince = DateTime.Now, Paging = null });
            Assert.IsType<List<IObjectAliasModel>>(response);
        }
        [Fact][Trait("Category", "ObjectAliases")]
        ...
        {
            var service = AppHost.Container.Resolve<IObjectAliasesServices>();
            var response = service.Any(new CreateObjectAlias { Name = "Stephen King", CustomKey = "KING-STEPHEN", Active = true, CreatedDate = DateTime.Now, UpdatedDate = DateTime.Now });
            Assert.Equal(nameof(IObjectAliasModel), response.GetType().Name.Replace("Proxy", ""));
        }
        [Fact][Trait("Category", "ObjectAliases")]
