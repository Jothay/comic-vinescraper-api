// <auto-generated>
// <copyright file="Publishers.IPublisherServices.cs" company="clarityventures.com">
...
namespace ComicVine.API.Testing.Services//.Publishers
{
    ...
    public partial class AllServicesTests
    {
        ...
        public void Verify_GetPublishers_Should_ReturnAListOfPublisherModels()
        {
            ...
            var response = service.Any(new GetPublishers { Id = 1, CustomKey = "KING-STEPHEN", ApiDetailUrl = "/TEST/KING-STEPHEN", Name = "Stephen King", Description = null, ModifiedSince = DateTime.Now, Paging = null });
        ...
        {
            var service = AppHost.Container.Resolve<IPublishersServices>();
            var response = service.Any(new GetPublishersAsListing { Id = 1, CustomKey = "KING-STEPHEN", ApiDetailUrl = "/TEST/KING-STEPHEN", Name = "Stephen King", Description = "famous", ModifiedSince = DateTime.Now, Paging = null });
            Assert.IsType<List<IPublisherModel>>(response);
        }
        [Fact][Trait("Category", "Publishers")]
        ...
        {
            var service = AppHost.Container.Resolve<IPublishersServices>();
            var response = service.Any(new CreatePublisher { Name = "Stephen King", CustomKey = "KING-STEPHEN", Active = true, CreatedDate = DateTime.Now, UpdatedDate = DateTime.Now });
            Assert.Equal(nameof(IPublisherModel), response.GetType().Name.Replace("Proxy", ""));
        }
        [Fact][Trait("Category", "Publishers")]
