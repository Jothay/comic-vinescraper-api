// <auto-generated>
// <copyright file="Promos.IPromoServices.cs" company="clarityventures.com">
...
namespace ComicVine.API.Testing.Services//.Promos
{
    ...
    public partial class AllServicesTests
    {
        ...
        public void Verify_GetPromos_Should_ReturnAListOfPromoModels()
        {
            ...
            var response = service.Any(new GetPromos { Id = 1, CustomKey = "KING-STEPHEN", ApiDetailUrl = "/TEST/KING-STEPHEN", Name = "Stephen King", Description = null, ModifiedSince = DateTime.Now, Paging = null });
        ...
        {
            var service = AppHost.Container.Resolve<IPromosServices>();
            var response = service.Any(new GetPromosAsListing { Id = 1, CustomKey = "KING-STEPHEN", ApiDetailUrl = "/TEST/KING-STEPHEN", Name = "Stephen King", Description = "famous", ModifiedSince = DateTime.Now, Paging = null });
            Assert.IsType<List<IPromoModel>>(response);
        }
        [Fact][Trait("Category", "Promos")]
        ...
        {
            var service = AppHost.Container.Resolve<IPromosServices>();
            var response = service.Any(new CreatePromo { Name = "Stephen King", CustomKey = "KING-STEPHEN", Active = true, CreatedDate = DateTime.Now, UpdatedDate = DateTime.Now });
            Assert.Equal(nameof(IPromoModel), response.GetType().Name.Replace("Proxy", ""));
        }
        [Fact][Trait("Category", "Promos")]
