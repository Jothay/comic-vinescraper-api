// <auto-generated>
// <copyright file="Issues.IIssueAliasServices.cs" company="clarityventures.com">
...
namespace ComicVine.API.Testing.Services//.Issues
{
    ...
    public partial class AllServicesTests
    {
        ...
        public void Verify_GetIssueAliases_Should_ReturnAListOfIssueAliasModels()
        {
            ...
            var response = service.Any(new GetIssueAliases { Id = 1, CustomKey = "KING-STEPHEN", ApiDetailUrl = "/TEST/KING-STEPHEN", Name = "Stephen King", Description = null, ModifiedSince = DateTime.Now, Paging = null });
        ...
        {
            var service = AppHost.Container.Resolve<IIssueAliasesServices>();
            var response = service.Any(new GetIssueAliasesAsListing { Id = 1, CustomKey = "KING-STEPHEN", ApiDetailUrl = "/TEST/KING-STEPHEN", Name = "Stephen King", Description = "famous", ModifiedSince = DateTime.Now, Paging = null });
            Assert.IsType<List<IIssueAliasModel>>(response);
        }
        [Fact][Trait("Category", "IssueAliases")]
        ...
        {
            var service = AppHost.Container.Resolve<IIssueAliasesServices>();
            var response = service.Any(new CreateIssueAlias { Name = "Stephen King", CustomKey = "KING-STEPHEN", Active = true, CreatedDate = DateTime.Now, UpdatedDate = DateTime.Now });
            Assert.Equal(nameof(IIssueAliasModel), response.GetType().Name.Replace("Proxy", ""));
        }
        [Fact][Trait("Category", "IssueAliases")]
