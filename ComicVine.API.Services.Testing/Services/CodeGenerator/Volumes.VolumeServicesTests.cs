// <auto-generated>
// <copyright file="Volumes.IVolumeServices.cs" company="clarityventures.com">
...
namespace ComicVine.API.Testing.Services//.Volumes
{
    ...
    public partial class AllServicesTests
    {
        ...
        public void Verify_GetVolumes_Should_ReturnAListOfVolumeModels()
        {
            ...
            var response = service.Any(new GetVolumes { Id = 1, CustomKey = "KING-STEPHEN", ApiDetailUrl = "/TEST/KING-STEPHEN", Name = "Stephen King", Description = null, ModifiedSince = DateTime.Now, Paging = null });
        ...
        {
            var service = AppHost.Container.Resolve<IVolumesServices>();
            var response = service.Any(new GetVolumesAsListing { Id = 1, CustomKey = "KING-STEPHEN", ApiDetailUrl = "/TEST/KING-STEPHEN", Name = "Stephen King", Description = "famous", ModifiedSince = DateTime.Now, Paging = null });
            Assert.IsType<List<IVolumeModel>>(response);
        }
        [Fact][Trait("Category", "Volumes")]
        ...
        {
            var service = AppHost.Container.Resolve<IVolumesServices>();
            var response = service.Any(new CreateVolume { Name = "Stephen King", CustomKey = "KING-STEPHEN", Active = true, CreatedDate = DateTime.Now, UpdatedDate = DateTime.Now });
            Assert.Equal(nameof(IVolumeModel), response.GetType().Name.Replace("Proxy", ""));
        }
        [Fact][Trait("Category", "Volumes")]
