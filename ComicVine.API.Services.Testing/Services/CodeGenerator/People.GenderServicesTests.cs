// <auto-generated>
// <copyright file="People.IGenderServices.cs" company="clarityventures.com">
...
namespace ComicVine.API.Testing.Services//.People
{
    ...
    public partial class AllServicesTests
    {
        ...
        public void Verify_GetGenders_Should_ReturnAListOfGenderModels()
        {
            ...
            var response = service.Any(new GetGenders { Id = 1, CustomKey = "KING-STEPHEN", ApiDetailUrl = "/TEST/KING-STEPHEN", Name = "Stephen King", Description = null, ModifiedSince = DateTime.Now, Paging = null });
        ...
        {
            var service = AppHost.Container.Resolve<IGendersServices>();
            var response = service.Any(new GetGendersAsListing { Id = 1, CustomKey = "KING-STEPHEN", ApiDetailUrl = "/TEST/KING-STEPHEN", Name = "Stephen King", Description = "famous", ModifiedSince = DateTime.Now, Paging = null });
            Assert.IsType<List<IGenderModel>>(response);
        }
        [Fact][Trait("Category", "Genders")]
        ...
        {
            var service = AppHost.Container.Resolve<IGendersServices>();
            var response = service.Any(new CreateGender { Name = "Stephen King", CustomKey = "KING-STEPHEN", Active = true, CreatedDate = DateTime.Now, UpdatedDate = DateTime.Now });
            Assert.Equal(nameof(IGenderModel), response.GetType().Name.Replace("Proxy", ""));
        }
        [Fact][Trait("Category", "Genders")]
