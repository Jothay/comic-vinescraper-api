// <auto-generated>
// <copyright file="Locations.ILocationServices.cs" company="clarityventures.com">
...
namespace ComicVine.API.Testing.Services//.Locations
{
    ...
    public partial class AllServicesTests
    {
        ...
        public void Verify_GetLocations_Should_ReturnAListOfLocationModels()
        {
            ...
            var response = service.Any(new GetLocations { Id = 1, CustomKey = "KING-STEPHEN", ApiDetailUrl = "/TEST/KING-STEPHEN", Name = "Stephen King", Description = null, ModifiedSince = DateTime.Now, Paging = null });
        ...
        {
            var service = AppHost.Container.Resolve<ILocationsServices>();
            var response = service.Any(new GetLocationsAsListing { Id = 1, CustomKey = "KING-STEPHEN", ApiDetailUrl = "/TEST/KING-STEPHEN", Name = "Stephen King", Description = "famous", ModifiedSince = DateTime.Now, Paging = null });
            Assert.IsType<List<ILocationModel>>(response);
        }
        [Fact][Trait("Category", "Locations")]
        ...
        {
            var service = AppHost.Container.Resolve<ILocationsServices>();
            var response = service.Any(new CreateLocation { Name = "Stephen King", CustomKey = "KING-STEPHEN", Active = true, CreatedDate = DateTime.Now, UpdatedDate = DateTime.Now });
            Assert.Equal(nameof(ILocationModel), response.GetType().Name.Replace("Proxy", ""));
        }
        [Fact][Trait("Category", "Locations")]
