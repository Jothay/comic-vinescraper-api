// <auto-generated>
// <copyright file="Characters.ICharacterAliasServices.cs" company="clarityventures.com">
...
namespace ComicVine.API.Testing.Services//.Characters
{
    ...
    public partial class AllServicesTests
    {
        ...
        public void Verify_GetCharacterAliases_Should_ReturnAListOfCharacterAliasModels()
        {
            ...
            var response = service.Any(new GetCharacterAliases { Id = 1, CustomKey = "KING-STEPHEN", ApiDetailUrl = "/TEST/KING-STEPHEN", Name = "Stephen King", Description = null, ModifiedSince = DateTime.Now, Paging = null });
        ...
        {
            var service = AppHost.Container.Resolve<ICharacterAliasesServices>();
            var response = service.Any(new GetCharacterAliasesAsListing { Id = 1, CustomKey = "KING-STEPHEN", ApiDetailUrl = "/TEST/KING-STEPHEN", Name = "Stephen King", Description = "famous", ModifiedSince = DateTime.Now, Paging = null });
            Assert.IsType<List<ICharacterAliasModel>>(response);
        }
        [Fact][Trait("Category", "CharacterAliases")]
        ...
        {
            var service = AppHost.Container.Resolve<ICharacterAliasesServices>();
            var response = service.Any(new CreateCharacterAlias { Name = "Stephen King", CustomKey = "KING-STEPHEN", Active = true, CreatedDate = DateTime.Now, UpdatedDate = DateTime.Now });
            Assert.Equal(nameof(ICharacterAliasModel), response.GetType().Name.Replace("Proxy", ""));
        }
        [Fact][Trait("Category", "CharacterAliases")]
