// <auto-generated>
// <copyright file="Episodes.IEpisodeServices.cs" company="clarityventures.com">
...
namespace ComicVine.API.Testing.Services//.Episodes
{
    ...
    public partial class AllServicesTests
    {
        ...
        public void Verify_GetEpisodes_Should_ReturnAListOfEpisodeModels()
        {
            ...
            var response = service.Any(new GetEpisodes { Id = 1, CustomKey = "KING-STEPHEN", ApiDetailUrl = "/TEST/KING-STEPHEN", Name = "Stephen King", Description = null, ModifiedSince = DateTime.Now, Paging = null });
        ...
        {
            var service = AppHost.Container.Resolve<IEpisodesServices>();
            var response = service.Any(new GetEpisodesAsListing { Id = 1, CustomKey = "KING-STEPHEN", ApiDetailUrl = "/TEST/KING-STEPHEN", Name = "Stephen King", Description = "famous", ModifiedSince = DateTime.Now, Paging = null });
            Assert.IsType<List<IEpisodeModel>>(response);
        }
        [Fact][Trait("Category", "Episodes")]
        ...
        {
            var service = AppHost.Container.Resolve<IEpisodesServices>();
            var response = service.Any(new CreateEpisode { Name = "Stephen King", CustomKey = "KING-STEPHEN", Active = true, CreatedDate = DateTime.Now, UpdatedDate = DateTime.Now });
            Assert.Equal(nameof(IEpisodeModel), response.GetType().Name.Replace("Proxy", ""));
        }
        [Fact][Trait("Category", "Episodes")]
