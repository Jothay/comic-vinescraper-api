// <auto-generated>
// <copyright file="Teams.TeamRepositoryTests.cs" company="jothay.com">
// Copyright (c) 2015 Jothay Tech, Inc. All rights reserved.
// </copyright>
// <summary>Declares the TeamsRepositoryTests class.</summary>
...
namespace ComicVineScraper.API.Testing.Repositories.Teams
{
    ...
    public static class TeamsMockingSetup
    {
        public static Mock<DataModel.ModelEntities> DoMockingSetupForContext(bool includeTeamsData, out Mock<IDbSet<Team>> mockSetTeams, bool markATeamInactive = false)
        {
            ...
            {
                new Team { Id = 1, Active = !markATeamInactive, CreatedDate = createDate, CustomKey = "KING-STEPHEN", ApiDetailUrl = "/TEST/KING-STEPHEN", },
                new Team { Id = 2, Active = true, CreatedDate = createDate.AddDays(1), CustomKey = "NIVEN-LARRY", ApiDetailUrl = "/TEST/NIVEN-LARRY", }
            }).AsQueryable();
