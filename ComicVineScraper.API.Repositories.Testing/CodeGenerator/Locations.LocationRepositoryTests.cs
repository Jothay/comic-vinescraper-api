// <auto-generated>
// <copyright file="Locations.LocationRepositoryTests.cs" company="jothay.com">
// Copyright (c) 2015 Jothay Tech, Inc. All rights reserved.
// </copyright>
// <summary>Declares the LocationsRepositoryTests class.</summary>
...
namespace ComicVineScraper.API.Testing.Repositories.Locations
{
    ...
    public static class LocationsMockingSetup
    {
        public static Mock<DataModel.ModelEntities> DoMockingSetupForContext(bool includeLocationsData, out Mock<IDbSet<Location>> mockSetLocations, bool markALocationInactive = false)
        {
            ...
            {
                new Location { Id = 1, Active = !markALocationInactive, CreatedDate = createDate, CustomKey = "KING-STEPHEN", ApiDetailUrl = "/TEST/KING-STEPHEN", },
                new Location { Id = 2, Active = true, CreatedDate = createDate.AddDays(1), CustomKey = "NIVEN-LARRY", ApiDetailUrl = "/TEST/NIVEN-LARRY", }
            }).AsQueryable();
