// <auto-generated>
// <copyright file="Series.SeriesRepositoryTests.cs" company="jothay.com">
// Copyright (c) 2015 Jothay Tech, Inc. All rights reserved.
// </copyright>
// <summary>Declares the SeriesRepositoryTests class.</summary>
...
namespace ComicVineScraper.API.Testing.Repositories.Series
{
    ...
    public static class SeriesMockingSetup
    {
        public static Mock<DataModel.ModelEntities> DoMockingSetupForContext(bool includeSeriesData, out Mock<IDbSet<Series>> mockSetSeries, bool markASeriesInactive = false)
        {
            ...
            {
                new Series { Id = 1, Active = !markASeriesInactive, CreatedDate = createDate, CustomKey = "KING-STEPHEN", ApiDetailUrl = "/TEST/KING-STEPHEN", },
                new Series { Id = 2, Active = true, CreatedDate = createDate.AddDays(1), CustomKey = "NIVEN-LARRY", ApiDetailUrl = "/TEST/NIVEN-LARRY", }
            }).AsQueryable();
