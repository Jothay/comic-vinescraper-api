// <auto-generated>
// <copyright file="Videos.VideoTypeRepositoryTests.cs" company="jothay.com">
// Copyright (c) 2015 Jothay Tech, Inc. All rights reserved.
// </copyright>
// <summary>Declares the VideoTypesRepositoryTests class.</summary>
...
namespace ComicVineScraper.API.Testing.Repositories.Videos
{
    ...
    public static class VideoTypesMockingSetup
    {
        public static Mock<DataModel.ModelEntities> DoMockingSetupForContext(bool includeVideoTypesData, out Mock<IDbSet<VideoType>> mockSetVideoTypes, bool markAVideoTypeInactive = false)
        {
            ...
            {
                new VideoType { Id = 1, Active = !markAVideoTypeInactive, CreatedDate = createDate, CustomKey = "KING-STEPHEN", ApiDetailUrl = "/TEST/KING-STEPHEN", },
                new VideoType { Id = 2, Active = true, CreatedDate = createDate.AddDays(1), CustomKey = "NIVEN-LARRY", ApiDetailUrl = "/TEST/NIVEN-LARRY", }
            }).AsQueryable();
    ...
    public class VideoTypesRepositoryTests
    {
        ...
        public void Verify_Get_ByID_Should_ReturnTheCorrectVideoType()
        {
            ...
            var videoTypes = repository.Get(1);
            // Assert
                        Assert.Equal("/TEST/KING-STEPHEN", videoTypes.ApiDetailUrl);
        }
        ...
        public void Verify_List_Should_ReturnAListOfVideoTypesWithData()
        {
            ...
            Assert.Equal("/TEST/KING-STEPHEN", videoTypes[0].ApiDetailUrl);
            Assert.Equal(2, videoTypes[1].Id);
            Assert.Equal("/TEST/NIVEN-LARRY", videoTypes[1].ApiDetailUrl);
        }
        ...
        public void Verify_Search_Should_ReturnAListOfVideoTypesWithDataMatchingSearchParameters()
        {
            ...
            Assert.Equal("/TEST/NIVEN-LARRY", videoTypes[0].ApiDetailUrl);
        ...
        public void Verify_Search_WithSelectStatement_Should_ReturnAListOfDynamicObjects()
        {
            ...
            var searchModel = new Mock<IVideoTypeSearchModel>();
            // Act
            var videoTypes = repository.Search(searchModel.Object, i => new { i.Id, MyApiDetailUrl = i.ApiDetailUrl }).ToArray();
            // Assert
            Assert.Equal(1, videoTypes.Length);
            Assert.Equal(2, videoTypes[0].Id);
            Assert.Equal("/TEST/NIVEN-LARRY", videoTypes[0].MyApiDetailUrl);
            // Stephen King was filtered out because he was Inactive
        }
