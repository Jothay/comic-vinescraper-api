...
namespace ComicVine.API.Mappings//.Characters
{
    ...
    public static class CharacterAppearedInIssueMapperExtensions
    {
        ...
        public static void MapToEntity(this ICharacterAppearedInIssueModel model, ref ICharacterAppearedInIssue entity)
        {
            Mapper.MapToEntity(model, ref entity);
        }
        public static ICharacterAppearedInIssueModel MapToModel(this ICharacterAppearedInIssue entity)
        {
            return Mapper.MapToModel(entity);
        }
        public static ICharacterAppearedInIssueModel MapToModelLite(this ICharacterAppearedInIssue entity)
        {
            return Mapper.MapToModelLite(entity);
        }
        public static ICharacterAppearedInIssueModel MapToModelListing(this ICharacterAppearedInIssue entity)
        {
