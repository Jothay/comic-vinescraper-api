// <auto-generated>
// <copyright file="dbo.IIssueModel.cs" company="clarityventures.com">
...
namespace ComicVine.API.Mappings//.dbo
{
    ...
    public class IssueMapper : IIssueMapper
    {
        ...
        public IIssueModel MapToModel(IIssue entity)
        {
            ...
            // Associated Objects
            model.IssueAliases = entity.IssueAliases?.Where(i => i.Active).Select(IssueAliasMapperExtensions.MapToModel).ToList();
            // Return Entity
            return model;
        }
