...
namespace ComicVine.API.Models
{
    ...
    public partial class TeamModel : NameableEntityModel, ITeamModel
    {
        // Team Properties
        // <None>
        // Related Objects
        ...
        // Associated Objects
        public List<ICharacterModel> CharacterFriends { get; set; }
        public List<ICharacterModel> CharacterEnemies { get; set; }
        public List<IIssueModel> IssueAppearances { get; set; }
        public List<IIssueModel> IssueCredits { get; set; }
        public List<IIssueModel> DisbandedInIssues { get; set; }
        public List<IMovieModel> Movies { get; set; }
        public List<ITeamAliasModel> TeamAliases { get; set; }
        public List<ICharacterModel> TeamMembers { get; set; }
...
{
    public partial class TeamSearchModel : NameableEntitySearchModel, Interfaces.SearchModels.ITeamSearchModel
    {
