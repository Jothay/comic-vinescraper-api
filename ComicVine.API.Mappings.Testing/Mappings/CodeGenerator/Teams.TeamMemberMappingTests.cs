...
namespace ComicVine.API.Testing.Mappings.Teams
{
    ...
    public class TeamMemberMappingExtensionsTests
    {
        ...
        public void Verify_MapToEntityExtension_CallsMapToEntity()
        {
            ...
            mockMapper.Setup(x => x.MapToEntity(It.IsAny<ITeamMemberModel>()));
            ...
            // Assert
            mockMapper.Verify(x => x.MapToEntity(It.IsAny<ITeamMemberModel>()), Times.Once);
        }
        ...
        //    // Arrange
        //    var mockMapper = new Mock<TeamMemberMapper>();
        //    mockMapper.Setup(x => x.MapToEntity(It.IsAny<ITeamMemberModel>(), ref It.IsAny<ITeamMember>()));
        //    var mockModel = TeamMembersMockingSetup.DoMockingSetupForTeamMemberModel(1);
        ...
        //    // Assert
        //    mockMapper.Verify(x => x.MapToEntity(It.IsAny<ITeamMemberModel>(), ref It.IsAny<ITeamMember>()), Times.Once);
        //}
        ...
        public void Verify_MapToModelExtension_CallsMapToModel()
        {
            // Arrange
            var mockMapper = new Mock<TeamMemberMapper>();
            mockMapper.Setup(x => x.MapToModel(It.IsAny<ITeamMember>()));
            var mockEntity = TeamMembersMockingSetup.DoMockingSetupForTeamMember(1);
            TeamMemberMapperExtensions.OverrideMapper(mockMapper.Object);
            // Act
            mockEntity.Object.MapToModel();
            // Assert
            mockMapper.Verify(x => x.MapToModel(It.IsAny<ITeamMember>()), Times.Once);
        }
        ...
        public void Verify_MapToModelLiteExtension_CallsMapToModel()
        {
            // Arrange
            var mockMapper = new Mock<TeamMemberMapper>();
            mockMapper.Setup(x => x.MapToModelLite(It.IsAny<ITeamMember>()));
            var mockEntity = TeamMembersMockingSetup.DoMockingSetupForTeamMember(1);
            TeamMemberMapperExtensions.OverrideMapper(mockMapper.Object);
            // Act
            mockEntity.Object.MapToModelLite();
            // Assert
            mockMapper.Verify(x => x.MapToModelLite(It.IsAny<ITeamMember>()), Times.Once);
        }
        ...
        public void Verify_MapToModelListingExtension_CallsMapToModel()
        {
            // Arrange
            var mockMapper = new Mock<TeamMemberMapper>();
            mockMapper.Setup(x => x.MapToModelListing(It.IsAny<ITeamMember>()));
            var mockEntity = TeamMembersMockingSetup.DoMockingSetupForTeamMember(1);
            TeamMemberMapperExtensions.OverrideMapper(mockMapper.Object);
            // Act
            mockEntity.Object.MapToModelListing();
            // Assert
            mockMapper.Verify(x => x.MapToModelListing(It.IsAny<ITeamMember>()), Times.Once);
        }
